...
if __name__ == '__main__':
    ...
    parser.add_argument("--lidar_points", type=str,
                        default="/home/manan/host/gem_sim/src/POLARIS_GEM_e2_Simulator/gem_calib_tools/src/data/lidar_cal_points.npy",
                        help="Path to saved LiDAR calibration points file (e.g., lidar_cal_points.npy)")
    parser.add_argument("--image", type=str,
                        default="/home/manan/host/gem_sim/src/POLARIS_GEM_e2_Simulator/gem_calib_tools/src/data/image_1.png",
                        help="Path to a calibration image (e.g., color0.png)")
    parser.add_argument("--intrinsics", type=str,
                        default="/home/manan/host/gem_sim/src/POLARIS_GEM_e2_Simulator/gem_calib_tools/src/data/camera_intrinsics.json",
                        help="Path to camera intrinsics JSON file (e.g., camera_intrinsics.json)")
    parser.add_argument("--output", type=str,
                        default="/home/manan/host/gem_sim/src/POLARIS_GEM_e2_Simulator/gem_calib_tools/src/data/extrinsics.npz",
