...
if __name__ == "__main__":
    ...
    parser.add_argument("--lidar_npz", type=str, default="/home/manan/host/gem_sim/src/POLARIS_GEM_e2_Simulator/gem_calib_tools/src/data/lidar_1.npz",
                        help="Path to the LiDAR npz file (from the paired capture)")
    parser.add_argument("--output", type=str, default="/home/manan/host/gem_sim/src/POLARIS_GEM_e2_Simulator/gem_calib_tools/src/data/lidar_cal_points.npy",
